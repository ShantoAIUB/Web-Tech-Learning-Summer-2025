    ...
    <div class="maindiv">
      <main class="form-container">
       ...
       <table class="rowsandcoms" id="gradesTable">
                    ...
                    <tbody id="gradesBody">
                        <tr>
                            <td id="sub" name="Subject"></td>
                            <td id="marks" name="Marks"></td>
                            <td id="gpa" name="GPA"></td>
                        </tr>
                    </tbody>
                </table>
      ...
      fetch('../Controller/StudentGradesController.php?json=true')
        ...
        .then(data => {
          ...
          data.grades.forEach(grade => {
            ...
            row.innerHTML = `<td>${grade.Subject}</td><td>${grade.Marks}</td><td>${grade.GPA}</td>`;
            totalMarks += parseInt(grade.Marks);
